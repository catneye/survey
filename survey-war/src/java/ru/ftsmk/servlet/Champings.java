 ...
 * @author plintus
 */
public class Champings extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            if ((userinfo != null)
                    && (action != null)
                    && ((action.equals("champings")||(action.equals("reports"))))
                ...
                out.print("<th class='defaulttableheader' style='width:10%'>Тип</th>");
                out.print("<th class='defaulttableheader' style='width:10%'>Доступна</th>");
                out.print("<th class='defaulttableheader' style='width:20%'>Дата создания</th>");
                out.print("</tr>");
                List<ChampingInfo> chis = chEjb.getChampingsByCompany(userinfo.getIdcompany());
                for (ChampingInfo chi : chis) {
                    ...
                    out.print("<td class='defaulttable'>" + chi.getChampingtype() + "</th>");
                    out.print("<td class='defaulttable'>" + (chi.getIsenable() ? "Да" : "Нет") + "</th>");
